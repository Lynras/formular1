...
export const fetchConstructors = () => async dispatch => {
    const response = await ergast.get('/api/f1/constructors?limit=211&offset=0.json');
    dispatch({type: 'FETCH_CONSTRUCTORS', payload: response.data.MRData.ConstructorTable.Constructors})
};
