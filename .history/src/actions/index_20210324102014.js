...
export const fetchWinners = () => async dispatch => {
    const response = await ergast.get('/api/f1/2008/5/driverStandings');
    dispatch({type: 'FETCH_WINNERS', payload: response.data.MRData.StandingsTable.StandingsLists.DriverStandings})
};
